...
public class GeoXACML {
    ...
    public static synchronized void initialize(FunctionFactoryProxy factoryProxy) {
        registerGeoXACMLAttributes();
        registerGeoXACMLBaseFunctions(factoryProxy);
    }

    private static void registerGeoXACMLBaseFunctions(FunctionFactoryProxy factoryProxy) {

        FunctionFactory factory = factoryProxy.getGeneralFactory();
        ...
        //Registering custom set functions is broken in Balana, see https://github.com/wso2/balana/issues/141
